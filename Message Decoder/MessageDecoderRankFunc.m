...
message = handles.MessageEdit.String;
...
spaceNum = 0;%number of spaces & punctuation
%% Frequency
%counts and removes spaces & punctuation
...
for u = 1:messageLength
    for v = u:length(letterRankArray)
        
        if strcmp(message(u), alphabetF{1,v})
           
            messageDecrypted(u) = letterRankArray(v);
...
handles.MessageText.String = messageDecrypted;
